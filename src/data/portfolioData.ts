...
export const PERSONAL_INFO = {
  ...
  bio: "Architecting fault-tolerant LLM infrastructure, real-time multi-agent workflows, hybrid RAG engines, and low-latency computer vision pipelines for production-grade scale.",
  ...
  heroSubtitle: "AI System Architect specializing in production LLM architectures, agentic workflows with LangGraph, human-in-the-loop validation, and sub-100ms inference pipelines.",
