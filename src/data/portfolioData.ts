...
export const PERSONAL_INFO = {
  name: "Ernest Zimba",
  title: "AI Systems Architect & ML Engineer",
  handle: "@Nestcy",
  email: "nyt4146@gmail.com",
  secondaryEmail: "nestcy770@gmail.com",
  phone: "+260973732409",
  location: "15833/1080 Kamwala South, Lusaka, Zambia",
  birthday: "July 30, 2006",
  bio: "I build production-ready AI applications that combine large language models, Retrieval-Augmented Generation (RAG), agentic workflows, and backend engineering to solve real-world problems. My work focuses on designing reliable, scalable systems that retrieve, reason, and act.",
  availability: "Open for AI Engineering Roles, Advisory & System Consulting",
  github: "https://github.com/Nestcy",
  linkedin: "https://linkedin.com/in/ernest-zimba-904661318",
  twitter: "https://x.com/nestcy",
  profileImage: "/src/assets/images/ernest_zimba_profile_1787503261020.jpg",
  avatarUrl: "/src/assets/images/ernest_zimba_profile_1787503261020.jpg",
  heroTitle: "Building Intelligent Systems, Not Just Software.",
  heroSubtitle: "I build production-ready AI applications that combine large language models, Retrieval-Augmented Generation (RAG), agentic workflows, and backend engineering to solve real-world problems. My work focuses on designing reliable, scalable systems that retrieve, reason, and act.",
  heroTechStack: ["Python", "LangGraph", "FastAPI", "Groq", "PostgreSQL", "PyTorch", "Redis", "Docker", "React"],
  heroCtaPrimaryText: "View Projects",
  heroCtaSecondaryText: "Resume CV",
  stats: [
    { label: "Approval Gates", value: "2 (Plan & Day)" },
    { label: "Publishing Control", value: "100% Human In Loop" },
    { label: "FastAPI Latency", value: "<120ms" },
    { label: "Production Agents", value: "Multi-Agent" },
  ]
};
